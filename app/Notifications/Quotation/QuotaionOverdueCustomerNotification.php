...
class QuotationOverdueCustomerNotification extends BaseNotification
{
	use Queueable;
	...
	{
		return $this->mailSettings()->get('quotation_overdue_customer_mail_subject');
	}
	...
	{
		return $this->mailSettings()->get('quotation_overdue_customer_mail_template');
	}
}
