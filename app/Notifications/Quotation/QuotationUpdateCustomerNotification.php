...
class QuotationUpdateCustomerNotification extends BaseNotification
{
	use Queueable;
	...
	{
		return $this->mailSettings()->get('quotation_update_customer_mail_subject');
	}
	...
	{
		return $this->mailSettings()->get('quotation_update_customer_mail_template');
	}
}
