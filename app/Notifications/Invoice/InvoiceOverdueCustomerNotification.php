...
class InvoiceOverdueCustomerNotification extends BaseNotification
{
	use Queueable;
	...
	{
		return $this->mailSettings()->get('invoice_overdue_customer_mail_subject');
	}
	...
	{
		return $this->mailSettings()->get('invoice_overdue_customer_mail_template');
	}
}
