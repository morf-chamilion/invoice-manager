...
class InvoiceUpdateCustomerNotification extends BaseNotification
{
	use Queueable;
	...
	{
		return $this->mailSettings()->get('invoice_update_customer_mail_subject');
	}
	...
	{
		return $this->mailSettings()->get('invoice_update_customer_mail_template');
	}
}
