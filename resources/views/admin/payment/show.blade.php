                        ...
                        <div class="row">
                            <div class="col-lg-12 mb-8">
                                ...
                                <x-input-date id="date" name="date" :value="old('date')"
                                    data-locale-format="YYYY-MM-DD" readonly required />
                                <x-input-error :messages="$errors->get('date', $payment->date)" />
                            </div>

                            <div class="col-lg-6 mb-8">
                                <x-input-label for="customer_id" :value="__('Customer')" required />
                                <x-input-select name="customer_id" data-placeholder="Select Customer" readonly required>
                            ...
                            <div>
                                ...
                                <x-input-textarea name="notes" id="notes" readonly>
