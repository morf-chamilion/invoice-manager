                ...
                <div class="card mt-8">
                    ...
                    <div class="card-body">
                                    ...
                                    <div class="mb-4 form-group">
                                        ...
                                        <div class="input-group">
                                            <x-input-text type="number" name="unit_price" id="unit_price"
                                                min="0" step="0.01" />
                                            <span class="input-group-text">{{ $quotation->vendor->currency }}</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        @php
                            ...
                            $discountValue = old('discount_value', $quotation->discount_value);
                            $discountType = old('discount_type', $quotation->discount_type);

                            $totalPrice = \App\Services\QuotationService::calculateTotal(
                                $items,
                                $discountValue,
                                $discountType,
                            );
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="1" class="border-right-0">
                                            <select class="form-select" name="discount_type" id="discountType">
                                                <option value="fixed" @selected(old('discount_type', $quotation->discount_type) === 'fixed')>
                                                    {{ __('Fixed') }}
                                                </option>
                                    ...
                                    <tr class="bg-gray-100">
                                        ...
                                        <td colspan="2" class="border-right-0 py-7">
                                            <span class="font-weight-bolder h3 d-block text-end">
                                                <span>{{ $quotation->vendor->currency }}</span>
