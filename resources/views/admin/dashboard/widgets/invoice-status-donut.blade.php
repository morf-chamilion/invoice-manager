<div class="card mb-5">
    ...
    <div class="card-body d-flex justify-content-between flex-column pb-0 px-2 pt-5">
        <div id="kt_invoice_status_donut_chart" style="height: 410px;"></div>
    </div>
</div>

@push('footer')
    <script>
        function initInvoiceStatusDonutChart(data) {
            let element = document.getElementById('kt_invoice_status_donut_chart');
        ...
        initInvoiceStatusDonutChart(@json($invoiceStatusDistribution->toArray()));
    </script>
@endpush
